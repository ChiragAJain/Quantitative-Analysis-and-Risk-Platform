...
class StockAnalyzer:
    ...
    def get_portfolio_summary(self):
        ...
        total_market_cap_proxy = len(self.stock_data)  # Simplified proxy
        ...
        return {
            ...
            'data_points': sum([data['trading_days'] for data in individual_summary.values()]),
            'total_observations': len(self.calculate_returns()) * len(self.stock_data)
        }